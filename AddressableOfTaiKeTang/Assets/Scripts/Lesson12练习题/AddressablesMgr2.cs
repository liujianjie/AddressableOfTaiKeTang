...
public class AddressablesMgr2 : MonoBehaviour
{
    private static AddressablesMgr2 instance = new AddressablesMgr2();
    public static AddressablesMgr2 Instance => instance;
